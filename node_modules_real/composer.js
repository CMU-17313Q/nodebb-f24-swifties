...
define('composer', [
	...
	// Add MP3 button handling
	// composer.addButton('fa-file-audio-o', function () {
	// 	$('#mp3-files').trigger('click'); // Trigger the hidden MP3 file input
	// }, 'Upload MP3');

	// $('#mp3-files').on('change', function (e) {
	// 	const files = e.target.files;
	// 	if (files && files.length) {
	// 		uploads.processMP3Upload(composer.active, files); // Trigger MP3 upload process
	// 	}
	// });
